/*
 BEGINNER NOTES (AUTO):
 - Archivo: Packages/AppModules/Sources/Core/Domain/UseCases/WordSearchUseCases.swift
 - Rol principal: Agrupa operaciones del dominio para un objetivo concreto de la app.
 - Flujo simplificado: Entrada: solicitud de una funcionalidad. | Proceso: orquestar repositorios/servicios. | Salida: respuesta lista para presentacion.
 - Tipos clave en este archivo: GetDailyPuzzleUseCase,StartDailySessionUseCase ValidateSelectionUseCase,MarkWordFoundUseCase
 - Funciones clave en este archivo: execute,execute execute,execute execute,refresh
