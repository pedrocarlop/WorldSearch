/*
 BEGINNER NOTES (AUTO):
 - Archivo: Packages/AppModules/Sources/Core/Domain/Entities/WordSearchEntities.swift
 ...
 - Tipos clave en este archivo: DayKey,WordId Word,GridPosition
 - Funciones clave en este archivo: contains,word asSession
