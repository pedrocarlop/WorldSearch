/*
 BEGINNER NOTES (AUTO):
 - Archivo: Packages/AppModules/Sources/Core/Data/Repositories/LocalSharedPuzzleRepository.swift
 ...
 - Tipos clave en este archivo: LocalSharedPuzzleRepository
 - Funciones clave en este archivo: loadState,saveState clearProgress,updateProgress currentRotationBoundary,decodeState
